...
之所以想写这个文章，一方面因为客观上上个项目实践渐多；一方面作为一个入行时受整洁代码、测试驱动开发、重构、设计模式等技术深深感染的后端，在日渐壮大的前端群体中却一直感觉缺乏相应的语境。加之最近在看程墨的《深入浅出 React & Redux》——这本可以说是我认为目前国内讲 React 最好的书——里面讲单元测试的一章，一些关于测试和 TDD 的观点，让我觉得有必要说说这个话题。不论如何，前端单元测试一直是我想要诉说的实践，所以，才有了这篇文章。

老实说，我知道前端界对于测试的态度是相对暧昧的，对于有落地难度的测试策略和实践是抱质疑态度的。其体现就是，有团队成员看完这个测试策略以后第一反应表示，太复杂了。

太复杂了。我相信这可能也是看完本文后有些读者心里暗暗的声音。我也许可以理解。我自己的立场呢，也在鲜明地坚持「不会写是能力问题，不写是态度问题」和这种也许可以理解中摇摆不定。也许两者都有吧，目前我只能说，我从理解质疑中收获了有用的东西，然后依然要先分享下这个我认为有价值的单元测试策略。

当我们看到复杂的测试策略时，可能会下意识想，对对对，但是太复杂了；但我们看到 React 复杂的生态圈、Angular 一揽子的解决方案时，你会怎么想？「卧槽我还有好多东西要学习！」「太复杂了，还是 Vue 好，我要去学 Vue。」但即便 Vue 的上手速度快，里面这些编程的概念——双向绑定、MVVM、数据状态、生命周期——我看也没有比测试简单到哪去吧？为什么看到框架我们第一反应是「学」（不管是要赶紧学，还是学别的，总归是学），而听到测试我们第一反应更多是「难」呢？再把一些跟前端开发联系紧密的东西放在一起：安全内置、DevOps 内置、前后端全栈开发、敏捷实践…在你心里，是不是已经默默为他们排起了学习次序呢？
...
Jul 17, 2018 茅丝的时候又读了一下程墨的《深入浅出》，发现他原来的观点并不完全是这样的。感觉心态平和许多。后面改一下这个目录、导读，不喷程墨了，说说大家对测试的恐惧，对测试的认知。讲清楚测试应该是第一公民。动力何在呢？你想成为优秀的开发者吗？

Jul 20, 2018 跟凤凤聊了一下，又觉得：写作本来就是唯一警醒和表达正义的空间。现实中你反而做不到。所以，文章一定要激烈，旗帜鲜明，三观非常正确。做人可以温和，观点可以包容，世界观可以见得很多而理解很多，但写文章就不行，太过理解纠结只能什么事情都做不成。一定不要强求一致。写文章就要观点鲜明，鼓励正义，推着好人去做好事。这样社会才有希望。这是写作价值观的问题。
...
谈到单元测试，可能我们会想到很多词语和元素：jest、describe/it、expect……
