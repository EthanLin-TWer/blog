...
1. 为什么要写这篇文章
   ...
   2. 从后端来，深受 Clean-Code 和 TDD-Refactoring 感染；入前端后，发现前端群体都专注在怎么写出代码上，对单元测试这一块重视度较后端低（怎么得出这个结论？凭感觉？），从而导致写出来的代码不具可测性，往往也不符合基本的 SRP 设计原则，较难维护和读懂，更无法重构，因为没有测试。所以，我也想来聊聊，为什么我们要做单元测试，好的单元测试是什么样，以及怎么写好 React 应用的单元测试
2. 为什么要做单元测试
