...
你看，这样的改进方向就是非常实打实且可度量的。虽然说压榨时间的方式主要是在团队内找到其他owner来承担对应的事务，但是有了这份PDCA清单，我们可以更清楚地看到TL可以给owner设定的期望：前至需求管理与技术方案发现，内关注团队内部的开结卡流程，外要与PO与外部团队对接，同时还要与TL定期同步信息等。
