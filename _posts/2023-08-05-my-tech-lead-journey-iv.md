...
* **对于每个会议邀请，搞清楚你是required还是optional。Optional的会直接不去，会后看会议纪要输出的信息就行**。
...
主动出击约会，你就有了制定议程、压缩会议时间的主动权。怎么知道自己需要约什么会呢？这就需要知道自己需要与哪些角色定期保持沟通或汇报。可以从你的工作职责出发来考虑。比如我前面提到，TL的主要职责有仨：提前保证未来迭代需求和技术设计输入、跟Feature Owner保持定期沟通、跟PO每日沟通迭代事务和交付进展。此外，有时还要跟更
